...
<body>
        ...
        <a href="{{route('admin')}}"class="btn border  text-white  ">Back
            ...
            <div class="col-4 text-center text-white  p-3 font">Update Prodect Type</div>
...
<form action="{{route('updateprodtype',$data->id)}}" method="POST" enctype="multipart/form-data">
@csrf
@method('PUT')
<div class='row justify-content-center mt-5'>
    <div class="col-auto justify-content-center  p-1">
<input class="w-100" type="text" name="name"  placeholder=" Enter Prodect type:"value="{{$data->name}}">
    </div>
