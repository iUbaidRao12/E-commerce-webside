...
<div class="container-fluid">
        ...
        <a href="{{route('admin')}}"class="btn border  text-white  ">Back
            ...
            <div class="col-4 text-center text-white  p-3 font">All Video's</div>
            <div class="col-4 justify-content-end d-flex ">
        <a href="{{route('videoform')}}"class="btn border  text-white ">Add Video
...
<div class="row m-sm-4 m-2">
    <div class="col-6 justify-content-start d-flex">
                  ...
                  <form action="{{route('delete_vid',$item->id)}}"method="post">
                    @csrf
                    @method('DELETE')
    ...
    <div class="col-6 justify-content-end d-flex"><a href="{{route('edit_vid',$item->id)}}"><button type="submit"class="btn btn-secondary">Update</button></a></div>
