...
<br>
    <body>
        ...
        <a href="{{route('admin')}}"class="btn border  text-white  ">Back
            ...
            <div class="col-4 text-center text-white  p-3 font">Add Video's</div>
            <div class="col-4 justify-content-end d-flex ">
        <a href="{{route('all_video')}}"class="btn border  text-white ">View Video's
...
<div class='row justify-content-center mt-5'>
    ...
    <div class="col-auto justify-content-center  p-1">
<input class="w-100" type="text" name="title"  placeholder=" Enter Category Name:">
    </div>
